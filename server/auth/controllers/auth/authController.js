...
const PROFILE_FIELDS = 'name username email bio avatar location website socials isProfilePublic isAccountVerified createdAt';

export const getMe = async (req, res) => {
    try {
        const user = await userModel.findById(req.user.userId).select(PROFILE_FIELDS);
